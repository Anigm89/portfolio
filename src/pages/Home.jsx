...
function Home(){
    ...
    return(
        ...
        <section>
            ...
            <div className='about'>
                <p>Comencé como desarrolladora web utilizando PHP, trabajando tanto en el frontend como en el backend. En mis primeros años, he trabajado el frontend con HTML5, CSS, JavaScript y jQuery para crear interfaces de usuario responsivas y modernas, además he desarrollado algún proyecto con Bootstrap.
                    En el backend, he trabajado principalmente con PHP y JavaScript Vanilla (ES6), utilizando bases de datos relacionales como MySQL para gestionar la información de las aplicaciones.</p>
